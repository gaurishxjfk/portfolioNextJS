...
const Tabs = () => {
  ...
  return (
    <div className={` h-[540px] w-[493px] mx-auto rounded-3xl px-3 pb-3 text-center -rotate-6 ${theme === 'light' ? 'bg-white border-black drop-shadow-2xl stroke-black' : 'bg-stone-900/[0.9]'}`}>
      <div className=" h-[15%]  pt-5">
        <h5 className={`font-bold text-2xl flex-1 text-transparent ${theme === 'light' ? lightTheme.head : darkTheme.head}`}>so far worked on...</h5>
      </div>      
